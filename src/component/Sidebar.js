    ...
    <aside className="basis-2/12 sidebar">
      <div>
        <div className="p-3 mb-3">
          <h1 className="text-xl font-bold text-center text-blue-700">E-Task</h1>
        </div>
        {/* Lists Menu */}
        {menus.map((menu, i) => (
        ...
        <div className="px-6 text-sm py-1 text-gray-500 flex items-center">
          ...
          <img src="https://static.vecteezy.com/system/resources/thumbnails/002/275/847/small/male-avatar-profile-icon-of-smiling-caucasian-man-vector.jpg" alt="avatar-user" className="avatar mr-2" />
          <h1>Nama User</h1>
        </div>
        <div className="px-6 text-sm py-1 text-gray-500 flex items-center">
          <span className="mr-4 w-2 h-2 bg-green-500 inline-block rounded-full"></span>
